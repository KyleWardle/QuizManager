                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach($User->QuizAttempts as $Attempt)
                                        <tr @if($Attempt->has_passed) class="table-success" @else class="table-danger" @endif >
                                            ...
                                            <td>
                                                @if(!$Attempt->quiz_end_time && $Attempt->Quiz->deleted_at === null)
                                                    <a href="{{ route('takeQuiz', [$Attempt->quiz_id, $Attempt->id]) }}" class="btn btn-info btn-sm">Continue</a>
                                                @endif
